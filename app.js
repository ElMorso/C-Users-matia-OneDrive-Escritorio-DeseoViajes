...
function mostrarArray() {
    ...
    Swal.fire({
        title: 'Todo listo',
        text: 'Tus datos quedaron guardados. Muchas gracias por tuilizar DeseoViajes',
        icon: 'success',
        confirmButtonText: 'Listo',
    })  
}

const apiaplicada = document.getElementById("apiaplicada"); 
...
apiaplicada.innerText = JSON.stringify(json);
});


function mostrarmiapi() {
